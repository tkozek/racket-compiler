...
(module+ test
  (require rackunit
           cpsc411/langs/v5)
  (define-syntax-rule (check-by-interp asmplv5u)
    (check-equal? (interp-asm-pred-lang-v5/undead asmplv5u)
                  (interp-asm-pred-lang-v5/conflicts (conflict-analysis asmplv5u))))

;; M5 tests; Added by Trevor on March 8th 2026, multiple bindings allowed per let
(check-by-interp '(module
    ((locals (foobar.8.11 bat.1.13 foo.4.12 ball.7.9 foo.4.10))
     (undead-out
      (((foo.4.10) (ball.7.9 foo.4.10) ()) () (() () (foobar.8.11) ()))))
    (define L.fn.0.1
      ((locals
        (foo.3.2
         bat.1.6
      ...
      (begin
        ...
        (set! foo.4.1 r9)
        (if (true)
          (if (begin (set! tmp.14 -502092639) (= tmp.14 foobar.5.5))
            (if (>= foobar.8.4 1) (halt 1852032564) (halt -106704231))
            (begin
              (set! tmp.16 foo.4.1)
              (set! tmp.16 (+ tmp.16 1))
              (set! tmp.15 tmp.16)
...
(check-by-interp '(module
    ((locals (tmp.17 tmp.16 bat.0.12 bat.2.11))
     (undead-out
      ((tmp.16)
       (tmp.16)
       (bat.0.12)
      ...
      ((locals
       ...
       (undead-out
        ((rsi rdx rcx r8 r9 rbp)
         ...
         ((bat.0.5 foobar.5.4 foo.9.1 bat.8.2 rbp)
          ((tmp.13 foobar.5.4 foo.9.1 bat.8.2 rbp)
           (tmp.13 foobar.5.4 foo.9.1 bat.8.2 rbp)
           (foobar.5.4 foo.9.1 bat.8.2 foobar.6.8 rbp))
          (foobar.5.4 foo.9.1 bat.8.2 foobar.6.8 rbp))
         (((bat.2.10 foo.9.1 bat.8.2 foobar.6.8 rbp)
           (bat.2.10 foo.9.1 bat.8.2 foobar.6.8 rbp)
           (foo.9.1 bat.8.2 foobar.6.8 rbp))
          (((tmp.14 foo.9.1 bat.8.2 foobar.6.8 rbp)
            (foo.9.1 bat.8.2 foobar.6.8 rbp))
           (foo.9.1 bat.8.2 foobar.6.8 rbp)
           (foo.9.1 bat.8.2 foobar.6.8 rbp))
          ((tmp.15 foo.9.1 bat.8.2 foobar.6.8 rbp)
           (tmp.15 foo.9.1 bat.8.2 foobar.6.8 rbp)
           (foo.9.1 bat.8.2 foobar.6.8 rbp)))
    ...
    (begin
      ...
      (set! bat.2.11 tmp.17)
      (if (!= bat.2.11 1) (halt -335809824) (halt bat.0.12))))
)
(check-by-interp '(module
    ((locals
      (bat.9.14
        ...
        ((rsi rdx ball.1.3 rbp)
         ...
         ((foobar.2.1 ball.1.3 bat.9.2 rbp)
          ...
          ((ball.1.3 foobar.2.1 bat.9.2)
           (foobar.2.7 ball.1.3 foobar.2.1 bat.9.2)
           (ball.1.3 foobar.2.1 bat.9.2)
      ...
      (begin
        ...
        (if (false)
          ...
          (begin
            ...
            (if (begin (set! tmp.20 1) (= tmp.20 0))
              (set! ball.3.4 bat.9.2)
              (set! ball.3.4 0))
            (if (begin (set! tmp.21 1320805275) (< tmp.21 9223372036854775807))
              (halt 0)
              (halt 0))))))
    (define L.tmp.1.2
...
(check-by-interp '(module
    ((locals (tmp.7 tmp.5 ball.8.1 ball.7.2 ball.5.3 tmp.4 tmp.6))
     (undead-out
      ((tmp.4)
       (tmp.4)
       (ball.5.3)
    ...
    (begin
      ...
      (if (begin (set! tmp.5 0) (!= tmp.5 9223372036854775807))
...
(check-by-interp '(module
    ((locals (foo.6.18 foo.7.19 tmp.23 foo.6.14 foo.1.15 foo.7.16 bat.4.17))
    ...
    (define L.tmp.1.2
      ((locals
       ...
       (undead-out
        ((rbp)
         (() (foo.6.7) () () (tmp.20) (tmp.20) (foo.7.4) (foo.7.4) () () ())
      ...
      (if (true)
        ...
        (if (begin
              ...
              (begin (set! tmp.21 1474008962) (< tmp.21 ball.0.13)))
          (if (begin (set! tmp.22 -566856990) (!= tmp.22 -9223372036854775808))
            (halt 1)
            (halt 1056302987))
          (jump L.tmp.1.2 rbp))))
    (begin
      ...
      (if (begin (set! tmp.23 -1846550218) (>= tmp.23 1836975164))
...
(check-by-interp '(module
    ((locals ()) (undead-out ((rsi rbp) (rsi rdi rbp) (rsi rdi rbp))))
    (define L.func.0.1
      ((locals (foo.9.1 foobar.5.2 foo.2.3 bar.6.4 bat.7.5 bat.0.6))
       (undead-out
        ((rsi rdx rcx r8 r9 bat.0.6)
         (rdx rcx r8 r9 bat.0.6)
         (rcx r8 r9 bat.0.6)
         (r8 r9 bat.0.6)
         (r9 bat.0.6)
         (bat.0.6)
      ...
      ((locals
       ...
       (undead-out
        ((rsi foobar.1.8)
         ...
         ((foobar.1.8 bar.3.10)
          ((tmp.23 bar.3.10) (tmp.23 bar.3.10) (bar.3.10))
          (bar.3.10))
         ())))
      (begin
        (set! foobar.1.8 rdi)
    ...
    (define L.tmp.0.1
      ((locals
       ...
       (undead-out
        ((rsi rdx rcx r8 r9 foobar.0.6)
         ...
         (((bar.3.2 foo.5.4 bar.7.7)
           ((bar.3.2 tmp.9 foo.5.4 bar.7.7) (foo.5.4 bar.7.7))
      ...
      (begin
        ...
        (if (if (!= bar.7.7 foobar.0.6)
              (begin (set! tmp.9 -494940107) (<= tmp.9 bar.3.2))
              (begin (set! tmp.10 0) (< tmp.10 1869530139)))
          (if (<= bar.7.7 0) (halt 0) (halt -777687734))
          (if (begin (set! tmp.11 -9223372036854775808) (> tmp.11 foo.5.4))
            (halt 9223372036854775807)
            (halt -9223372036854775808)))))
    (halt 9223372036854775807))
)
(check-by-interp '(module
    ((locals (tmp.3 foo.0.2 foo.8.1))
     (undead-out (() (() () ()) (((tmp.3) ()) () ()))))
    (if (true)
      (begin (set! foo.0.2 1) (set! foo.8.1 0) (halt 356048754))
      (if (begin (set! tmp.3 -1287356538) (<= tmp.3 1126106862))
        (halt 4712028)
        (halt 349517812))))
)
(check-by-interp '(module
    ((locals
      (ball.6.42 bat.4.44 foobar.7.43 bar.5.41 bar.2.40 bat.4.39 tmp.54))
     (undead-out
      (((tmp.54) ())
       ((bar.5.41) (bar.5.41) (bar.5.41) ())
       (() () (ball.6.42) ()))))
    (define L.fn.0.1
      ((locals
        (ball.6.11
      ...
      (begin
        ...
        (set! bar.8.3 tmp.46)
        (if (begin (set! tmp.47 1) (>= tmp.47 0))
        ...
        (if (begin (set! tmp.48 0) (= tmp.48 foobar.1.1))
          (halt 1)
          (halt -9223372036854775808))))
    (define L.func.1.2
      ((locals
      ...
      (begin
        ...
        (set! bar.2.21 r9)
        (set! bat.4.20 fv0)
        (if (begin (set! tmp.49 -68053908) (>= tmp.49 1924767324))
          (begin
            (set! rcx foobar.7.24)
            (set! rdx 2037093174)
            (set! rsi 2020389049)
    ...
    (define L.func.2.3
      ((locals
       ...
       (undead-out
        ((rsi rdx rcx foobar.0.30)
         ...
         (foobar.0.30 ball.3.28 bat.4.29)
         (foobar.0.30 ball.3.28 bat.4.29)
         (((foobar.0.30 tmp.50 ball.3.28 bat.4.29) (ball.3.28 bat.4.29))
          (ball.3.28 bat.4.29)
          (ball.3.28 bat.4.29))
         (ball.3.28 bat.4.29)
         (bat.4.29)
      ...
      (begin
        ...
        (if (begin (set! tmp.50 9223372036854775807) (>= tmp.50 foobar.0.30))
        ...
        (set! tmp.52 tmp.53)
        (halt tmp.52)))
    (if (not (begin (set! tmp.54 512244517) (> tmp.54 -294049298)))
      (begin
...
(check-by-interp '(module
    ((locals (tmp.29)) (undead-out (((tmp.29) ()) () ())))
    (define L.proc.0.1
      ((locals (foobar.0.1 foobar.4.2 bar.7.3 bat.1.4 foobar.8.5))
       (undead-out
        ((rsi rdx rcx r8 foobar.8.5 rbp)
         (rdx rcx r8 foobar.8.5 bat.1.4 rbp)
      ...
      ((locals
       ...
       (undead-out
        ((rsi foobar.4.7)
         (bar.2.6 foobar.4.7)
         ((bar.2.6 foobar.4.7)
          (((foobar.4.7) (foobar.4.7 foobar.0.10) (foobar.4.7 foobar.0.10))
           (tmp.22 foobar.0.10)
           (tmp.22 foobar.0.10)
           (foobar.0.10)
           (foobar.0.10)
    ...
    (define L.proc.2.3
      ...
      (begin
        ...
        (set! tmp.27 tmp.28)
        (halt tmp.27)))
    (if (begin (set! tmp.29 1) (> tmp.29 -735340476))
      (halt -9223372036854775808)
      (halt -1627211406)))
)
(check-by-interp '(module
    ((locals
      (bar.5.13 foobar.3.15 ball.0.16 bar.5.17 bat.7.18 bar.8.14 tmp.20))
     (undead-out
      (()
       (bar.5.17)
       (bar.5.17)
      ...
      (begin
        ...
        (if (not (false))
          (begin
            ...
            (set! ball.0.11 0)
            (halt 1))
          (begin (set! rdi -2072909432) (jump L.x.0.1 rbp rdi)))))
    (begin
      ...
      (if (begin (set! tmp.20 1) (< tmp.20 bar.8.14))
        (halt bar.8.14)
        (halt -9223372036854775808))))
)
(check-by-interp '(module
    ((locals (foobar.5.4 bar.1.1 tmp.8 tmp.7 bar.6.2 bar.4.3 tmp.6 bar.4.5))
     (undead-out
      ((tmp.6)
       (tmp.6)
       (bar.4.3)
    ...
    (begin
      ...
      (set! tmp.6 (* tmp.6 1))
      (set! bar.4.3 tmp.6)
      (if (begin (set! tmp.7 92310708) (<= tmp.7 1290581674))
        (set! bar.6.2 1)
        (set! bar.6.2 0))
...
(check-by-interp '(module
    ...
    (define L.func.0.1
      ((locals
       ...
       (undead-out
        ((bar.6.1)
         ...
         (tmp.10 bar.6.1)
         (bar.6.5 bar.6.1)
         (((bar.6.5 tmp.11 bar.6.1) (bar.6.1))
          (bar.6.1 bat.2.4)
          (bar.6.1 bat.2.4))
         (bar.6.1 bat.2.4 foo.7.3)
         (bar.6.1 bat.2.4 foobar.4.2 foo.7.3)
         (((bar.6.1 bat.2.4 foobar.4.2 foo.7.3)
           ((tmp.12 bar.6.1 bat.2.4 foobar.4.2 foo.7.3)
            (bar.6.1 bat.2.4 foobar.4.2 foo.7.3))
           ((tmp.13 bar.6.1 bat.2.4 foobar.4.2 foo.7.3)
            (bar.6.1 bat.2.4 foobar.4.2 foo.7.3)))
      ...
      (begin
        ...
        (set! bar.6.5 tmp.10)
        (if (begin (set! tmp.11 1) (<= tmp.11 bar.6.5))
          (set! bat.2.4 -9223372036854775808)
          (set! bat.2.4 -50606571))
        (set! foo.7.3 bar.6.1)
        (set! foobar.4.2 bar.6.1)
        (if (if (>= foo.7.3 bar.6.1)
              (begin (set! tmp.12 0) (< tmp.12 foo.7.3))
              (begin (set! tmp.13 1880363761) (!= tmp.13 9223372036854775807)))
          (begin (set! bat.3.8 1) (set! bar.6.7 foobar.4.2) (halt foo.7.3))
          (begin
            (set! tmp.15 bat.2.4)
            ...
            (halt tmp.14)))))
    (define L.x.1.2
      ((locals (tmp.16 tmp.17))
       (undead-out (() () ((tmp.17) (tmp.17) (tmp.16) ()))))
      (if (true)
        (halt -9223372036854775808)
        (begin
          (set! tmp.17 0)
...
(check-by-interp '(module
    ((locals (foo.4.5 foobar.2.4 tmp.6))
     (undead-out (((tmp.6) ()) (() () ()) ())))
    (define L.x.0.1
      ((locals (foobar.1.1 ball.6.2 ball.8.3))
       (undead-out
        ((rsi rdx ball.8.3 rbp)
         (rdx ball.8.3 rbp)
    ...
    (if (begin (set! tmp.6 9223372036854775807) (> tmp.6 1757631774))
      (begin
        (set! foo.4.5 0)
...
(check-by-interp '(module
    ((locals (bat.2.2 bat.0.3 ball.5.1 tmp.4))
     (undead-out (((tmp.4) ()) (() (bat.2.2) (bat.2.2) ()) ())))
    (if (not (begin (set! tmp.4 1946235623) (< tmp.4 -9223372036854775808)))
      (begin
...
(check-by-interp '(module
    ((locals (tmp.5 tmp.4)) (undead-out ((tmp.5) (tmp.5) (tmp.4) ())))
    (define L.proc.0.1
...
(check-by-interp '(module
    ((locals (tmp.20)) (undead-out (() () (((tmp.20) ()) () ()))))
    (define L.proc.0.1
      ((locals
        (ball.0.1
         foobar.7.2
         ...
         foobar.3.6))
       (undead-out
        ((rsi rdx rcx r8 r9 foobar.3.6 rbp)
         ...
         ((foobar.2.3 foobar.3.6 rbp)
          ((foobar.2.3 foobar.3.6 fv0 rbp)
           (foobar.3.6 fv0 r9 rbp)
    ...
    (if (true)
      (halt -1263415267)
      (if (begin (set! tmp.20 9223372036854775807) (<= tmp.20 -514434406))
        (halt 9223372036854775807)
        (halt 9223372036854775807))))
)
(check-by-interp '(module
    ((locals
      (bar.8.7 bat.9.10 ball.7.11 tmp.15 bat.3.8 tmp.14 ball.7.9 tmp.16))
     (undead-out
      ((tmp.14)
       (tmp.14)
       (ball.7.9)
    ...
    (define L.proc.0.1
      ((locals (bar.8.1 bat.6.2))
       (undead-out ((rsi rbp) (rbp) (rdi rbp) (rdi rbp))))
      (begin
        (set! bat.6.2 rdi)
        (set! bar.8.1 rsi)
        (set! rdi -9223372036854775808)
    ...
    (define L.tmp.1.2
      ((locals (bat.9.5 bar.2.6 bat.6.4 tmp.13 bat.6.3 tmp.12))
       (undead-out
        ((bat.6.3)
         (((tmp.12 bat.6.3) (bat.6.3))
          ((bat.6.3)
           ((bat.6.3) (bat.6.3) (bat.6.4) ())
           (((tmp.13 bat.6.3) (bat.6.3)) () ()))
          ()))))
      (begin
        (set! bat.6.3 rdi)
        (if (begin (set! tmp.12 9223372036854775807) (!= tmp.12 bat.6.3))
          (if (true)
            (begin
              ...
              (set! bat.6.4 bat.6.3)
              (halt bat.6.4))
            (if (begin (set! tmp.13 1890937388) (>= tmp.13 bat.6.3))
              (halt bat.6.3)
              (halt 1616264974)))
          (halt 9223372036854775807))))
    (begin
      ...
      (set! ball.7.9 tmp.14)
      (if (begin (set! tmp.15 -9223372036854775808) (< tmp.15 1))
...
(check-by-interp '(module
        ...
        (if (false)
          ...
          (if (false)
            (begin
              ...
              (halt foo.9.1))
            (if (begin (set! tmp.27 1) (> tmp.27 foo.9.1))
              (halt 822960898)
              (halt foo.9.1))))))
    (define L.fn.1.2
      ((locals
    ...
    (define L.fn.2.3
      ((locals (foo.0.21 foobar.5.22 foo.9.23 foobar.1.24 foo.4.25 foo.6.26))
       (undead-out
        ((rsi rdx rcx r8 r9 foo.6.26 rbp)
         (rdx rcx r8 r9 foo.4.25 foo.6.26 rbp)
...
(check-by-interp '(module
    ((locals (foobar.4.4 bat.8.3 foobar.7.2 bar.5.1 tmp.5))
     (undead-out (((tmp.5) ()) (() () ()) (() () ()))))
    (if (not (begin (set! tmp.5 1622421353) (>= tmp.5 94202816)))
      (begin
...
(check-by-interp '(module
    ((locals (tmp.13 foobar.5.7 foo.1.9 bar.4.8 tmp.12))
     (undead-out
      (((tmp.12) ()) (() () (foobar.5.7) ()) (((tmp.13) ()) () ()))))
    (define L.func.0.1
      ((locals
        (tmp.11 tmp.10 foo.1.2 ball.8.1 foo.2.3 foo.9.4 ball.7.6 bar.4.5))
       (undead-out
        ((rsi rdx rcx r8 r9 ball.7.6 rbp)
         ...
         (((foo.2.3 foo.1.2 foo.9.4 ball.8.1 bar.4.5 rbp)
          ...
          ((ball.8.1 bar.4.5 r9 rbp)
           ...
           (r9 r8 rcx rdx rsi rdi rbp)
           (r9 r8 rcx rdx rsi rdi rbp))
          ((foo.1.2 ball.8.1 r9 rbp)
           (foo.1.2 ball.8.1 r9 r8 rbp)
      ...
      (begin
        ...
        (if (if (> bar.4.5 ball.7.6)
              (if (begin (set! tmp.10 -1032056006) (= tmp.10 foo.1.2))
                (>= foo.2.3 ball.8.1)
                (< foo.9.4 1))
              (begin (set! tmp.11 1) (>= tmp.11 foo.9.4)))
          (begin
            (set! r9 foo.9.4)
            (set! r8 ball.8.1)
            (set! rcx 1807204646)
          ...
          (begin
            ...
            (set! rdi ball.8.1)
            (jump L.func.0.1 rbp rdi rsi rdx rcx r8 r9)))))
    (if (begin (set! tmp.12 -9223372036854775808) (!= tmp.12 -719419034))
      (begin
        (set! foo.1.9 9223372036854775807)
        (set! bar.4.8 0)
        (set! foobar.5.7 9223372036854775807)
        (halt foobar.5.7))
      (if (begin (set! tmp.13 -235413122) (> tmp.13 1))
        (halt 0)
        (halt 9223372036854775807))))
)
(check-by-interp '(module
    ...
    (define L.fn.0.1
      ((locals (ball.9.1))
       (undead-out
        ((ball.9.1 rbp) (ball.9.1 rsi rbp) (rsi rdi rbp) (rsi rdi rbp))))
      (begin
        (set! ball.9.1 rdi)
        (set! rsi ball.9.1)
        (set! rdi ball.9.1)
      ...
      (begin
        ...
        (if (not (false))
          ...
          (begin
            ...
            (set! foobar.0.9 0)
            (if (= bat.7.11 1) (halt foobar.0.9) (halt 0))))))
    (if (if (begin (set! tmp.21 1) (= tmp.21 -1319463227))
          (begin (set! tmp.22 -9223372036854775808) (>= tmp.22 1))
          (begin (set! tmp.23 -1520052689) (!= tmp.23 1)))
      (begin
...
(check-by-interp '(module
    ...
    (begin
      ...
      (set! foobar.9.7 0)
      (set! bar.4.1 1)
      (if (begin (set! tmp.9 -1508403451) (!= tmp.9 bat.2.3))
        (halt 447579047)
        (halt bat.2.3))))
)
(check-by-interp '(module
    ((locals (tmp.6 tmp.5)) (undead-out ((tmp.6) (tmp.6) (tmp.5) ())))
    (define L.tmp.0.1
      ((locals (foo.8.1 foobar.6.2 ball.9.3 foo.4.4))
       (undead-out
        ((rsi rdx rcx foo.4.4 rbp)
         (rdx rcx foo.4.4 rbp)
...
(check-by-interp '(module
    ((locals ()) (undead-out ((rsi rbp) (rsi rdi rbp) (rsi rdi rbp))))
    (define L.func.0.1
      ((locals (ball.7.1 bat.4.2))
       (undead-out
        ((rsi bat.4.2 rbp)
         (ball.7.1 bat.4.2 rbp)
    ...
    (define L.fn.1.2
      ...
      (begin
        ...
        (set! ball.2.3 rcx)
        (if (true)
          (if (if (begin (set! tmp.15 182929845) (> tmp.15 bar.8.5))
                (>= bat.1.4 1)
                (begin
       ...
       (undead-out
        (((tmp.20) ())
         ...
         ((((tmp.21) ()) (bat.4.14) (bat.4.14))
          ...
          (bat.4.14)
          (() () ())))))
      (if (begin (set! tmp.20 0) (< tmp.20 9223372036854775807))
        (halt 1083014636)
        (begin
          (if (begin (set! tmp.21 1) (<= tmp.21 9223372036854775807))
...
(check-by-interp '(module
    ((locals (ball.7.18 tmp.28 tmp.27 foobar.1.19 tmp.29))
     (undead-out
      ((tmp.27)
       (tmp.27)
       (foobar.1.19)
    ...
    (define L.proc.0.1
      ((locals (tmp.20 tmp.21 bat.2.2 ball.8.1))
       (undead-out
        ((((tmp.20 rbp) (tmp.20 rbp) (bat.2.2 rbp))
      ...
      (if (begin
            ...
            (if (> ball.8.1 bat.2.2)
              (begin (set! tmp.21 9223372036854775807) (>= tmp.21 ball.8.1))
              (= bat.2.2 0)))
        (halt -9223372036854775808)
        (begin
          (set! rdx 0)
    ...
    (define L.fn.1.2
        ...
        ((rsi rdx rcx r8 r9 fv0 bat.2.9)
         ...
         (((ball.9.4 foo.4.8 bar.6.3 foobar.1.6 bat.3.5 bat.2.9)
           (((tmp.22 foo.4.8 bar.6.3 foobar.1.6 bat.3.5 bat.2.9)
            ...
            ((tmp.23 bar.6.3 foobar.1.6 bat.3.5 bat.2.9)
      ...
      (begin
        ...
        (set! bar.6.3 fv0)
        (if (if (true)
              (if (begin (set! tmp.22 -1156972119) (!= tmp.22 bat.3.5))
                (begin (set! tmp.23 9223372036854775807) (> tmp.23 bat.2.9))
                (begin (set! tmp.24 1703616983) (!= tmp.24 foo.4.8)))
              (if (>= ball.9.4 bar.6.3)
                (> bat.3.5 bat.3.5)
                (< bat.2.9 bat.2.9)))
          (begin
            ...
            (if (>= bat.2.9 -2080421634) (halt 9223372036854775807) (halt 0)))
          (halt -274219017))))
    (define L.proc.2.3
      ((locals (tmp.26 ball.9.15 bat.2.16 ball.5.17 tmp.25))
       (undead-out
        ((rsi rdx) (rdx bat.2.16) (bat.2.16) (tmp.26) (tmp.26) (tmp.25) ())))
      (begin
        (set! ball.5.17 rdi)
        (set! bat.2.16 rsi)
        (set! ball.9.15 rdx)
    ...
    (begin
      ...
      (if (begin (set! tmp.29 0) (<= tmp.29 foobar.1.19))
        (halt 0)
        (halt 9223372036854775807))))
)
(check-by-interp '(module
    ((locals (bat.4.2 foobar.7.1 tmp.4 tmp.5 tmp.3))
     (undead-out (((tmp.3) ()) ((tmp.5) (tmp.5) (tmp.4) ()) (() () ()))))
    (if (begin (set! tmp.3 -107521481) (!= tmp.3 -1873066368))
      (begin
...
(check-by-interp '(module
    ((locals (tmp.18 tmp.16 ball.9.10 tmp.15 bat.5.11 tmp.17))
     (undead-out
      ((((tmp.15) ()) () ())
       (((tmp.16) ()) () ())
       (tmp.18)
      ...
      ((locals
       ...
       (undead-out
        ((foobar.4.5 rbp)
         ...
         (((tmp.12 bar.7.3 foobar.4.5 rbp) (bar.7.3 foobar.4.5 rbp))
          (rbp)
          (rbp))
         (((rbp) (bat.5.6 rbp) ((bat.5.6 tmp.13 rbp) (rbp)))
          ((bat.0.9 rbp) (bat.0.9 rbp) (rbp))
...
(check-by-interp '(module
    ((locals (bat.6.16 foo.3.19 ball.5.20 bat.6.21 bat.0.17 bar.7.18))
     (undead-out
      ((bar.7.18)
       (bat.0.17 bar.7.18)
       (bat.0.17 bar.7.18)
    ...
    (define L.func.0.1
      ((locals (bat.0.4 ball.8.5 tmp.22 bat.6.1 bat.0.2 bar.4.3 tmp.24 tmp.23))
       (undead-out
        (()
         (((tmp.22) ()) (() () () ()) ((tmp.24) (tmp.24) (tmp.23) ()))
         (() () (() () ())))))
      (if (false)
        (if (not
             (begin (set! tmp.22 -1086072832) (!= tmp.22 9223372036854775807)))
          (begin
    ...
    (define L.fn.1.2
       ...
       (undead-out
        ((rsi bat.0.7)
         ...
         (((bat.6.6 bat.0.7)
           ...
           ((bat.6.6 bat.0.7)
            ((tmp.28 bat.6.6 bat.0.7) (bat.6.6 bat.0.7))
            ((tmp.29 bat.6.6 bat.0.7) (bat.6.6 bat.0.7))))
          (((tmp.30 bat.0.7) (bat.0.7))
           (((tmp.31 bat.0.7) (bat.0.7)) () ())
           (((tmp.32) ()) () ()))
          ((foo.3.12 bat.0.7 bat.6.6)
           (foo.3.12 bat.0.7 bat.6.6)
           (bat.0.7 bat.6.6)
      ...
      (begin
        ...
        (set! bat.6.6 rsi)
        (if (if (true)
              (if (begin (set! tmp.25 0) (> tmp.25 9223372036854775807))
                (begin (set! tmp.26 1) (<= tmp.26 -330770905))
                (begin (set! tmp.27 0) (> tmp.27 bat.0.7)))
              (if (>= bat.0.7 bat.0.7)
                (begin (set! tmp.28 -1763336001) (<= tmp.28 1))
                (begin
          ...
          (if (not
               (begin
                 ...
                 (= tmp.30 1676706544)))
            (if (begin (set! tmp.31 0) (<= tmp.31 bat.0.7))
              (halt -9223372036854775808)
              (halt bat.0.7))
            (if (begin
    ...
    (begin
      ...
      (if (<= bar.7.18 bat.0.17) (halt 1132619346) (halt 0))))
)
(check-by-interp '(module
    ((locals (foo.5.5 foo.8.4 foobar.2.3 foobar.3.2 foo.8.1))
...
(check-by-interp '(module
    ((locals (foo.0.7 foo.0.1 ball.9.4 bat.3.5 bat.3.2 tmp.8 bar.1.3 bat.5.6))
     (undead-out
      ((((tmp.8) ()) (bar.1.3) (bar.1.3))
       (bar.1.3)
       (bar.1.3)
       (ball.9.4 bar.1.3)
       (bar.1.3)
       ...
       ())))
    (begin
      (if (begin (set! tmp.8 9223372036854775807) (> tmp.8 1398326902))
...
(check-by-interp '(module
    ((locals (tmp.17)) (undead-out ((rbp) (rbp) (((tmp.17) ()) () ()))))
    (define L.proc.0.1
      ((locals
        (tmp.9 foo.9.2 bat.6.3 tmp.8 bar.2.5 foo.9.4 tmp.10 tmp.11 bar.0.1))
       (undead-out
        ((() () ((tmp.8) (tmp.8) ()))
         ()
         (tmp.9)
      ...
      (begin
        (if (true)
          (set! bat.6.3 0)
          (begin (set! tmp.8 1) (set! tmp.8 (* tmp.8 1)) (set! bat.6.3 tmp.8)))
      ...
      ((locals (tmp.15 tmp.16 tmp.12 tmp.13 tmp.14 bat.6.6 ball.3.7))
       (undead-out
        (()
         ...
         ((tmp.16) (tmp.16) (tmp.15) ()))))
      (if (true)
        (if (if (begin (set! tmp.12 0) (< tmp.12 -9223372036854775808))
              (begin (set! tmp.13 0) (<= tmp.13 -9223372036854775808))
              (begin (set! tmp.14 9223372036854775807) (> tmp.14 -1813633866)))
          (halt -935154891)
          (begin
    ...
    (if (false)
      (jump L.proc.1.2 rbp)
      (if (begin (set! tmp.17 1) (!= tmp.17 9223372036854775807))
        (halt 313960847)
        (halt 0))))
)
(check-by-interp '(module
    ((locals (tmp.4 tmp.3 tmp.2 tmp.1))
     (undead-out
      ((((tmp.1) ()) ((tmp.2) ()) ((tmp.3) ())) (((tmp.4) ()) () ()) ())))
    (if (if (begin (set! tmp.1 -500842013) (< tmp.1 -2010375969))
          (begin (set! tmp.2 -1785958547) (< tmp.2 9223372036854775807))
          (begin (set! tmp.3 904902616) (<= tmp.3 1)))
      (if (begin (set! tmp.4 -1568723397) (= tmp.4 0))
        (halt 1)
        (halt -9223372036854775808))
      (halt 1)))
)
(check-by-interp '(module
    ((locals (tmp.1)) (undead-out (() () (((tmp.1) ()) () ()))))
    (if (false)
      (halt 0)
      (if (begin (set! tmp.1 1) (>= tmp.1 0))
        (halt 281602960)
        (halt 9223372036854775807))))
)
(check-by-interp '(module
    ((locals (tmp.3 tmp.1 tmp.2))
    ...
    (if (true)
      (begin
        ...
        (set! tmp.1 tmp.2)
        (halt tmp.1))
      (if (begin (set! tmp.3 901304193) (>= tmp.3 1))
        (halt 0)
        (halt -154349390))))
)
(check-by-interp '(module ((locals ()) (undead-out ())) (halt 9223372036854775807))
)
(check-by-interp '(module
    ((locals (foo.7.1 bar.2.2 tmp.3 tmp.4))
    ...
    (if (true)
      (begin
        ...
        (set! tmp.3 tmp.4)
        (halt tmp.3))
      (begin (set! bar.2.2 -644439618) (set! foo.7.1 1) (halt foo.7.1))))
)

;;
  ;; !!! Added by Trevor on March 2nd 2026
  (check-by-interp '(module ((locals ()) (undead-out ((rdi rbp) (rdi rbp))))
  ...
  (check-by-interp
   '(module ((locals (ball.9.9 bat.5.8)) (undead-out ((bat.5.8) (bat.5.8) ())))
      ...
      (begin
        ...
        (halt bat.5.8))))
  (check-by-interp
   '(module ((locals (tmp.13)) (undead-out (((tmp.13) ()) () ())))
            (define L.x.0.1
      ...
      (if (begin
          ...
          (halt 2101306416))))
  (check-by-interp
   '(module ((locals (tmp.7)) (undead-out (((tmp.7) ()) () ())))
            (define L.proc.0.1
  ...
  (check-by-interp '(module ((locals ()) (undead-out ((r8 rbp) (r8 rcx rbp)
                                                               (r8 rcx rdx rbp)
                                                               (r8 rcx rdx rsi rbp)
                                                               (r8 rcx rdx rsi rdi rbp)
                                                               (r8 rcx rdx rsi rdi rbp))))
  ...
  (check-by-interp
   '(module ((locals (ball.6.6)) (undead-out ((ball.6.6) ())))
            (define L.tmp.0.1
  ...
  (check-by-interp
   '(module ((locals (bat.0.13)) (undead-out (() ())))
            (define L.proc.0.1
              ((locals (ball.2.1 foo.7.2 ball.4.3)) (undead-out ((rsi rdx rbp) (rdx foo.7.2 rbp)
  ...
  (check-by-interp
   '(module ((locals (tmp.10)) (undead-out (((tmp.10) ()) () ())))
            (define L.func.0.1
  ...
  (check-by-interp
   '(module ((locals (bar.0.27)) (undead-out (() ())))
            (define L.x.0.1
              ((locals
  ...
  (check-by-interp
   '(module ((locals ()) (undead-out ((fv0 rbp) (fv0 r9 rbp)
      ...
      (begin
        ...
        (set! rdi -9223372036854775808)
        (jump L.tmp.0.1 rbp rdi rsi rdx rcx r8 r9 fv0))))
  (check-by-interp '(module ((locals (tmp.3 tmp.1 tmp.2)) (undead-out (() ((tmp.2) (tmp.2) (tmp.1) ())
                                                                          (((tmp.3) ()) () ()))))
                            (if (true)
                                (begin
                                  (set! tmp.2 1)
   ...
   '(module ((locals
      ...
      (define L.func.1.2
        ((locals (bar.9.8 foobar.1.9 tmp.45))
         (undead-out ((bar.9.8) (foobar.1.9 bar.9.8)
                                (((foobar.1.9 tmp.45 bar.9.8) (bar.9.8)) () ()))))
        (begin
