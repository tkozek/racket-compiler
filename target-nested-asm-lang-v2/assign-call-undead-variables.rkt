...
(module+ test
  ...
  (check-match (assign-call-undead-variables
                `(module ((new-frames ()) (locals (ball.2.3 foobar.3.1 bat.9.2 tmp-ra.4))
                                          (call-undead ())
  ...
  ;; Added by Trevor on March 6th 2026, at most one binding per let
  (check-by-interp
   '(module ((new-frames ()) (locals (ball.2.3 foobar.3.1 bat.9.2 tmp-ra.4))
                             (call-undead ())
                             (undead-out ((tmp-ra.4 rbp) (bat.9.2 tmp-ra.4 rbp)
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp.12 foobar.5.7 tmp-ra.9))
                             (call-undead ())
                             (undead-out ((tmp-ra.9 rbp) (((tmp.12 tmp-ra.9 rbp) (tmp-ra.9 rbp))
                                                          (foobar.5.7 tmp-ra.9 rbp)
                                                          (foobar.5.7 tmp-ra.9 rbp))
                                                         (tmp-ra.9 rax rbp)
                                                         (rax rbp)))
                             (conflicts ((tmp-ra.9 (rax tmp.12 foobar.5.7 rbp))
                                         (foobar.5.7 (rbp tmp-ra.9))
                                         (tmp.12 (rbp tmp-ra.9))
                                         (rbp (rax tmp.12 foobar.5.7 tmp-ra.9))
                                         (rax (rbp tmp-ra.9)))))
            (define L.func.0.1
              ((new-frames (()))
               (locals (foo.3.6 bat.2.3 foobar.9.4 foobar.8.5 foo.7.2 tmp.11 bat.0.1 tmp-ra.8 tmp.10))
  ...
  (check-by-interp '(module ((new-frames ()) (locals (tmp.3 foo.6.1 tmp-ra.2))
                                             (call-undead ())
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp-ra.5 tmp.6))
                             (call-undead ())
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp-ra.1 tmp.2))
                             (call-undead ())
                         ...
                         (undead-out ((tmp-ra.19 rbp) (((tmp.23 tmp-ra.19 rbp) (tmp-ra.19 rbp))
                                                       ...
                                                       ((tmp.24 tmp-ra.19 rbp)
                                                        ...
                                                        (((tmp.25 tmp-ra.19 rbp) (tmp-ra.19 rbp))
                                                         ...
                                                         ((tmp-ra.19 rax rbp) (rax rbp)))))))
                         (call-undead ())
                         (conflicts ((tmp.23 (rbp tmp-ra.19))
                                     (tmp-ra.19 (rbp tmp.23 ball.9.4 tmp.24 tmp.25 rax))
  ...
  (check-by-interp
   '(module ((new-frames ())
            ...
            (define L.proc.0.1
              ((new-frames ())
               (locals (bar.0.1 foo.6.2 bat.5.3 foo.8.4 tmp-ra.18))
      ...
      (define L.func.1.2
        ((new-frames ())
         (locals (bat.4.5 foo.9.6 bar.0.7 foo.8.8 bat.3.9 tmp-ra.19))
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp-ra.9))
                             ...
                             (undead-out ((tmp-ra.9 rbp) (tmp-ra.9 r8 rbp)
                                                         ...
                                                         (r8 rcx rdx rsi rdi r15 rbp)
                                                         (r8 rcx rdx rsi rdi r15 rbp)))
                             (conflicts ((tmp-ra.9 (rdi rsi rdx rcx r8 rbp))
                                         (rbp (r15 rdi rsi rdx rcx r8 tmp-ra.9))
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp-ra.9))
                             ...
                             (undead-out ((tmp-ra.9 rbp) (tmp-ra.9 rcx rbp)
                                                         ...
                                                         (rcx rdx rsi rdi r15 rbp)))
                             (conflicts ((tmp-ra.9 (rdi rsi rdx rcx rbp))
                                         (rbp (r15 rdi rsi rdx rcx tmp-ra.9))
        ...
        (if (false)
            ...
            (if (false)
                ...
                (begin
                  ...
                  (set! rax tmp.15)
                  (jump tmp-ra.9 rbp rax)))))))
  (check-by-interp '(module ((new-frames ()) (locals (foo.7.1 foo.5.3 foo.5.2 tmp-ra.4))
                                             (call-undead ())
  ...
  (check-by-interp
   '(module ((new-frames ())
            ...
            (define L.x.0.1
              ((new-frames (()))
               (locals (tmp-ra.8 foobar.2.1 bar.5.2 tmp.12))
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (foo.5.13 foo.6.15 tmp.22 bat.0.14 tmp-ra.18))
            ...
            (define L.fn.0.1
              ((new-frames ())
               (locals (bat.1.3 tmp.19 foo.5.4 foo.5.1 foobar.4.2 tmp-ra.16))
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (foobar.4.3 bat.1.2 foobar.4.5 tmp-ra.6 foo.0.4 bar.7.1 tmp.7))
             (call-undead ())
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (tmp.10 tmp-ra.8 foobar.4.6 foo.5.5))
             (call-undead ())
             (undead-out
              ((tmp-ra.8 rbp)
  ...
  (check-by-interp
   '(module ((new-frames (()))
            ...
            (define L.tmp.0.1
              ((new-frames ())
               (locals (foo.6.1 bar.2.2 ball.4.3 bar.8.4 bat.3.5 tmp-ra.7))
  ...
  (check-by-interp
   '(module ((new-frames (()))
             (locals (bar.5.10 tmp-ra.14 bat.3.8 bar.7.9))
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (tmp-ra.11 bar.8.9 tmp.13))
             (call-undead ())
  ...
  ;; Added by Trevor on March 6th 2026, multiple bindings allowed per let
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp.17 tmp-ra.13 tmp.16 tmp.15 tmp.14))
                             ...
                             (undead-out ((tmp-ra.13 rbp) ((((tmp.14 tmp-ra.13 rbp) (tmp-ra.13 rbp))
                                                           ...
                                                           (((tmp.17 tmp-ra.13 rbp) (tmp-ra.13 rbp))
                                                            ((tmp-ra.13 rax rbp) (rax rbp))
                                                            ((tmp-ra.13 rax rbp) (rax rbp))))))
                             (conflicts ((tmp.14 (rbp tmp-ra.13))
                                         (tmp.15 (rbp tmp-ra.13))
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp-ra.13 tmp.17))
            ...
            (define L.func.0.1
              ((new-frames (()))
               (locals (ball.4.4 tmp-ra.11 bar.2.5 foo.9.7 foo.9.3 foobar.5.2 bat.0.6 foo.6.1 tmp.14))
               (undead-out
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (bar.7.9 bat.9.10 tmp-ra.13))
             (call-undead ())
             (undead-out
  ...
  (check-by-interp
   '(module ((new-frames ())
      ...
      (define L.x.2.3
        ((new-frames (()))
         (locals (bar.9.10 tmp-ra.17 bat.8.13 foo.1.14 bar.9.11 ball.7.12))
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp-ra.25))
                             ...
                             (undead-out ((tmp-ra.25 rbp) (tmp-ra.25 rcx rbp)
                                                          ...
                                                          (rcx rdx rsi rdi r15 rbp)
                                                          (rcx rdx rsi rdi r15 rbp)))
                             (conflicts ((tmp-ra.25 (rdi rsi rdx rcx rbp))
                                         (rbp (r15 rdi rsi rdx rcx tmp-ra.25))
      ...
      (define L.proc.1.2
        ((new-frames (()))
         (locals (foo.6.11 foobar.7.12 foo.4.13 foo.2.8 foobar.7.9 foo.6.10 foo.6.7 tmp.27 tmp-ra.23))
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (bat.7.18 tmp.25 bat.6.19 bat.8.21 bar.2.20 tmp-ra.24))
             (call-undead ())
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (tmp.7 ball.0.1 bar.6.2 foobar.7.3 ball.0.4 bat.2.5 tmp-ra.6))
             (call-undead ())
             (undead-out ((tmp-ra.6 rbp) (tmp-ra.6 rbp)
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (foo.1.12 ball.9.13 tmp-ra.15))
                             (call-undead ())
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (bat.4.16 tmp.23 tmp-ra.20))
                             ...
                             (undead-out ((tmp-ra.20 rbp) (tmp.23 tmp-ra.20 rbp)
                                                          ...
                                                          (tmp-ra.20 rax rbp)
                                                          (rax rbp)))
                             (conflicts ((tmp-ra.20 (rax bat.4.16 tmp.23 rbp))
                                         (tmp.23 (rbp tmp-ra.20))
                                         (bat.4.16 (rbp tmp-ra.20))
                                         (rbp (rax bat.4.16 tmp.23 tmp-ra.20))
                                         (rax (rbp tmp-ra.20)))))
            (define L.fn.0.1
              ((new-frames ())
               (locals (bar.0.1 tmp-ra.17))
               (undead-out ((rdi tmp-ra.17 rbp)
      ...
      (begin
        ...
        (set! rax bat.4.16)
        (jump tmp-ra.20 rbp rax))))
  (check-by-interp '(module ((new-frames ()) (locals (bat.0.1 foobar.1.2 tmp-ra.3))
                                             (call-undead ())
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp-ra.10))
      ...
      (begin
        ...
        (set! rax 1)
        (jump tmp-ra.10 rbp rax))))
  (check-by-interp '(module ((new-frames ()) (locals (foobar.9.1 ball.3.2 tmp-ra.3))
                                             (call-undead ())
                                             (undead-out ((tmp-ra.3 rbp) (tmp-ra.3 rbp)
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (tmp.7 tmp.3 tmp.4 tmp.5 tmp-ra.2 tmp.6 bar.1.1))
             (call-undead ())
             (undead-out
              ((tmp-ra.2 rbp)
               ((tmp-ra.2 rbp)
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp-ra.17 tmp.19))
                             (call-undead ())
      ...
      (begin
        ...
        (if (begin
            ...
            (begin
              ...
              (jump tmp-ra.29 rbp rax))))))
  (check-by-interp
   '(module ((new-frames ()) (locals (foobar.1.1 ball.8.2 ball.7.3 tmp-ra.4))
                             (call-undead ())
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (bat.6.1 foo.5.2 bat.8.3 tmp.5 tmp-ra.4 tmp.6 tmp.7))
             (call-undead ())
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp.3 tmp-ra.1 tmp.2))
                             (call-undead ())
                             (undead-out ((tmp-ra.1 rbp) (((tmp.2 tmp-ra.1 rbp) (tmp-ra.1 rbp))
                                                          ((tmp-ra.1 rax rbp) (rax rbp))
  ...
  (check-by-interp
   '(module ((new-frames ()) (locals (tmp-ra.13))
      ...
      (define L.func.1.2
        ((new-frames (()))
         (locals (foobar.4.6 bat.3.7 bat.2.8 tmp.14 tmp-ra.11))
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (tmp.16 tmp-ra.14 foo.3.11 bat.6.10 foobar.4.9 tmp.15))
             (call-undead ())
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (ball.8.3 bat.6.2 foo.5.1 tmp-ra.4))
             (call-undead ())
             (undead-out ((tmp-ra.4 rbp)
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (ball.9.8 foo.4.2 foo.3.3 bar.0.4 ball.9.5 bar.7.6 foobar.8.7 ball.1.1 tmp-ra.9))
             (call-undead ())
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (foobar.1.10 foobar.3.11
                                  foobar.1.2
                                  tmp.13
                                  foo.8.3
                                  foobar.3.4
  ...
  (check-by-interp
   '(module ((new-frames ())
             (locals (bat.0.3 foo.5.4 ball.3.5 bat.0.1 bat.2.2 tmp.7 tmp-ra.6))
             (call-undead ())
