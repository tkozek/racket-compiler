...
(module+ test
  ...
  (check-by-interp '(begin
                      ...
                      (halt fv0)))
  (check-by-interp '(module (let ([bar.7.1 9223372036854775807]) bar.7.1)))
  (check-by-interp '(module (begin
                              (set! bar.7.1 9223372036854775807)
                              bar.7.1)))
  (check-by-interp '(module (let ([bar.0.2 -1259911970]
                                  [ball.2.1 -994523723])
                              0)))
  (check-by-interp '(begin
                      (set! fv0 1)
  ...
  (check-by-interp '(module (begin
                              ...
                              bar.3.1)))
  (check-by-interp '(module (let ([bat.5.3 287618957]
                                  [foobar.3.2 1]
                                  [bat.4.1 -104424799])
                              -1788782111)))
  (check-by-interp '(module (let ([bat.7.3 1]
                                  [bat.6.2 229035576]
  ...
  (check-by-interp '(begin
                      ...
                      (set! fv1 fv0)
                      (halt fv1)))
  (check-by-interp '(module (let ([foobar.9.1 (* 9223372036854775807 0)])
                              (let ([foo.3.3 0]
                                    [ball.4.2 (* 0 1)])
                                1126078786))))
  ...
  (check-by-interp '(module (let ([ball.6 -9223372036854775808]
  ...
  (check-by-interp '(begin
                      ...
                      (set! (rbp - 0) r10)
                      (set! rax -840991502)))
  (check-by-interp '(module (let ([ball.1.2 (+ 966813755 -1365911686)]
                                  [foo.5.1 -9223372036854775808])
                              (let ([ball.1.3 (+ foo.5.1 1)]) (let ([foo.3.4 foo.5.1]) 1)))))
  (check-by-interp '(module ()
                            (begin
                              ...
                              (set! foobar.2.1
                                    (begin
                                      ...
                                      (begin
                                        ...
                                        -1476120972)))
                              (* 0 1))))
  (check-by-interp '(module (let ([foo.2 0])
  ...
  (check-by-interp '(begin
                      ...
                      (set! fv29 fv0)
                      (halt fv29)))
  (check-by-interp '(module (let ([bar.8.1 (let ([bar.6.3 0]
