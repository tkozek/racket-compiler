...
(check-by-interp '(module (begin
                            (begin
                              ...
                              (begin
                                ...
                                (set! bar.0.11 0)
                                (set! foo.3.5 (+ 1 9223372036854775807))))
...
(check-by-interp '(module (begin
                            (begin
                              ...
                              (set! foobar.6.3 (+ -9223372036854775808 ball.7.4)))
                            (set! foobar.1.2 (* 1 0))
...
(check-by-interp '(module (begin
                            (begin
                              (begin
                                ...
                                (set! bar.3.5 (+ -1082669922 bar.2.8))))
                            (set! foo.9.4 1)
                            (begin
                              (begin
                                (set! bat.1.3 (* -259719214 1))))
...
(check-by-interp '(module (begin
                            (begin
                              ...
                              (begin
                                ...
                                (set! bat.7.2 (* 1043987471 -1675678395)))
                              (set! ball.2.1 (+ 0 0))
                              (begin
...
(check-by-interp '(module (begin
                            (begin
                              ...
                              (begin
                                ...
                                (set! foobar.0.3 (+ foobar.7.7 foobar.7.7))))
                            ...
                            (begin
                              ...
                              (begin
                                ...
                                (set! ball.1.26 (* bar.6.30 foobar.0.3)))
...
(check-by-interp '(module (begin
                            ...
                            (begin
                              ...
                              (set! bat.9.1 (* bar.1.22 9223372036854775807)))
                            (begin
...
(check-by-interp '(module (begin
                            ...
                            (begin
                              (begin
                                ...
                                (set! bat.2.12 1)
                                (set! ball.7.11 (* bar.4.13 bar.4.13)))
                              (begin
                                (set! bar.9.17 (+ 1 0))
                                (begin
                                ...
                                (set! foobar.3.14 (* 9223372036854775807 -9223372036854775808))
...
(check-by-interp '(module (begin
                            ...
                            (begin
                              ...
                              (set! foobar.2.2 (* bar.4.42 -364939322)))
                            (begin
