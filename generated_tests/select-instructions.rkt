...
(define-syntax-rule (check-by-interp p)
  (check-equal? (interp-imp-cmf-lang-v4 (check-imp-cmf-lang-v4 p))
                (interp-asm-pred-lang-v4 (check-asm-pred-lang-v4 (select-instructions p)))))
...
(check-by-interp '(module (begin
                            ...
                            (begin
                              ...
                              foobar.7.7))))
(check-by-interp '(module (begin
                            (if (>= 1224363849 -9223372036854775808)
...
(check-by-interp '(module (begin
                            ...
                            (begin
                              (begin
                                (set! foo.1.7 (* -9223372036854775808 -9223372036854775808)))
                              (if (= 0 0)
                                  (if (!= -9223372036854775808 0)
                                      (set! bar.6.6 571243347)
                                      (set! bar.6.6 610130973))
                                  (set! bar.6.6 (+ -9223372036854775808 1)))
                              (set! foo.5.5 1256333532)
                              (if (= 0 -1835378586)
                                  (begin
                                    (set! bat.0.4 1))
                                  (set! bat.0.4 (* -9223372036854775808 -424152180)))
                              (set! bat.7.2 bar.6.6))
                            (begin
                              ...
                              (if (>= -353070992 -388357885)
                                  (set! ball.2.8 (+ 1 0))
                                  (set! ball.2.8 (* -9223372036854775808 1)))
...
(check-by-interp '(module (begin
                            (begin
                              ...
                              (if (>= 844611670 -1394444838)
                                  (set! foo.8.6 0)
                                  (set! foo.8.6 1))
                              (set! foobar.0.5 (* 1461159574 886215187))
                              (set! bat.4.4 (+ foo.9.8 foobar.0.5)))
                            (if (begin
                                  (set! foo.8.14 1)
...
(check-by-interp '(module (begin
                            ...
                            (begin
                              ...
                              (if (> -9223372036854775808 -459088038)
                                  (set! foo.0.17 0)
                                  (set! foo.0.17 0))
                              (set! foobar.3.16 (+ 1521054237 935219322))
                              (set! ball.8.4 (+ foo.6.19 bat.1.18)))
                            (set! foo.6.3 1)
                            (set! bat.1.2 1)
                            ...
                            (if (true)
                                ...
                                (begin
                                  ...
                                  (if (> 1 -2075859550)
                                      ...
                                      (set! foobar.5.3 1))
                                  (set! ball.0.2 (* ball.0.4 ball.0.4))))
                            (begin
                              (if (true)
                                  (if (= -9223372036854775808 0)
                              ...
                              (set! foobar.6.1 (* bat.4.13 foobar.5.12)))
                            (begin
                              (begin
