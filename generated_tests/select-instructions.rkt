...
(check-by-interp '(module (begin
                            ...
                            (begin
                              ...
                              (set! bar.6.1 (* ball.1.4 1553839939)))
                            (begin
...
(check-by-interp '(module (begin
                            ...
                            (begin
                              ...
                              (begin
                                ...
                                (set! bat.7.11 (* 1 1))
                                (set! ball.6.9 (+ -1921282404 0)))
                              (set! bat.9.8 1)
                              (set! ball.2.7 -134738152)
                              (set! bar.8.5 (+ 0 bat.9.8)))
...
(check-by-interp '(module (begin
                            ...
                            (begin
                              ...
                              (set! bat.8.1 (* 9223372036854775807 bat.7.19)))
                            (begin
...
(check-by-interp '(module (begin
                            ...
                            (begin
                              (begin
                                ...
                                (set! bar.1.8 (* 0 -9223372036854775808)))
                              (set! bat.8.7 1)
                              ...
                              (begin
                                ...
                                (set! foobar.2.5 (+ -1762859866 -1973749130)))
                              (begin
                                (begin
                                  (set! ball.4.40 1)
                                ...
                                (set! bar.7.2 (* foobar.2.5 foo.0.31))))
