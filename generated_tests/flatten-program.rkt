...
(require rackunit
         cpsc411/langs/v4
         (only-in "../flatten-program.rkt" flatten-program))
(define-syntax-rule (check-by-interp p)
  (check-equal? (interp-block-asm-lang-v4 (para-asm-lang-v4? p))
                (interp-para-asm-lang-v4 (para-asm-lang-v4? (flatten-program p)))))
