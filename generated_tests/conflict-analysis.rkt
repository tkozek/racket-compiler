...
(define-syntax-rule (check-by-interp p)
  (check-equal? (interp-asm-pred-lang-v4/undead (check-asm-pred-lang-v4/undead p))
                (interp-asm-pred-lang-v4/conflicts
                 (check-asm-pred-lang-v4/conflicts (conflict-analysis p)))))

;;; Added by Trevor on 2026-03-18

(check-by-interp
 '(module ((locals (tmp.3 tmp.4 tmp.1 tmp.2)) (undead-out (() ((tmp.2) (tmp.2) (tmp.1) ())
                                                              ((tmp.4) (tmp.4) (tmp.3) ()))))
          (if (true)
              (begin
...
(check-by-interp
 '(module ((locals (ball.4.1 bar.3.3 foobar.1.2)) (undead-out (() (foobar.1.2) (foobar.1.2) ())))
          (begin
...
(check-by-interp
 '(module ((locals (tmp.4 foobar.1.1 foobar.4.3 foo.8.2 tmp.5))
           (undead-out ((foobar.4.3)
                        (tmp.4 foobar.4.3)
                        (tmp.4 foobar.4.3)
                        (foo.8.2 foobar.4.3)
                        (foo.8.2 foobar.1.1 foobar.4.3)
                        (((foo.8.2 tmp.5 foobar.1.1 foobar.4.3) (foobar.1.1 foobar.4.3)) () ()))))
          (begin
...
(check-by-interp '(module ((locals (tmp.8 tmp.6 foo.5.1 foobar.4.2 tmp.5 bar.9.3 tmp.4 tmp.7))
                           (undead-out ((tmp.4) (tmp.4)
                                                ...
                                                (tmp.5 bar.9.3)
                                                (bar.9.3)
                                                (((tmp.6 bar.9.3) (bar.9.3)) (foo.5.1 bar.9.3)
                                                                             (foo.5.1 bar.9.3))
                                                (bar.9.3 tmp.8)
                                                (tmp.8)
                                                (tmp.7)
...
(check-by-interp
 '(module ((locals (tmp.4 tmp.3 foobar.7.2 ball.3.1))
           (undead-out ((tmp.3) (tmp.3)
                                (foobar.7.2)
                                (((tmp.4 foobar.7.2) (foobar.7.2)) (foobar.7.2 ball.3.1)
                                                                   (foobar.7.2 ball.3.1))
                                ((ball.3.1) () ()))))
          (begin
            (set! tmp.3 0)
...
(check-by-interp
 '(module ((locals (tmp.5 foobar.2.2 ball.3.4 bar.1.1 bat.5.3))
           (undead-out ((() (bat.5.3) (bat.5.3) (bar.1.1 bat.5.3) ()) () (((tmp.5) ()) () ()))))
          (if (begin
...
(check-by-interp
 '(module ((locals (bar.2.5 foo.4.6 bar.1.8 bar.1.1 tmp.9 ball.0.2 foo.4.3 foobar.5.4 ball.9.7))
           (undead-out (() (foo.4.3)
                           (((tmp.9 foo.4.3) (foo.4.3)) (foo.4.3 ball.0.2) (foo.4.3 ball.0.2))
                           (bar.1.1 foo.4.3 ball.0.2)
                           (foo.4.3 ball.0.2)
                           (ball.0.2 ball.9.7)
                           (ball.0.2 ball.9.7)
                           (ball.9.7)
...
(check-by-interp
 '(module ((locals
           ...
           (undead-out (((tmp.9) ()) (() () () () (foo.7.1) ())
                                     ((ball.4.8) (ball.4.8) (ball.4.8) ()))))
          (if (not (begin
...
(check-by-interp
 '(module ((locals (bar.2.8 bat.5.1 bar.2.2 bat.8.3 tmp.10 bar.3.4 bar.7.5 bar.2.6 bar.6.7 bat.5.9))
           (undead-out (() (bar.2.6)
                           (bar.7.5)
                           (((tmp.10 bar.7.5) (bar.7.5)) (bar.7.5) (bar.7.5))
                           (bar.7.5 bat.8.3)
                           (bar.7.5 bat.8.3)
                           (bar.7.5 bat.8.3)
                           (bat.8.3 bat.5.9)
...
(check-by-interp
 '(module ((locals (foo.3.8 ball.2.10
                            ...
                            bar.8.2
                            bat.4.1))
           (undead-out (() (() (foobar.6.5) (foobar.6.5) (foobar.6.5) (foobar.6.5) (foobar.6.5) ())
                           (() () (foo.3.8) (foo.3.8) ()))))
          (if (false)
              (begin
                (set! foobar.7.6 0)
...
(check-by-interp
 '(module ((locals (foobar.2.1 foobar.5.3 bat.4.2 tmp.6 tmp.5 tmp.4))
           (undead-out ((((tmp.4) ()) ((tmp.5) ()) ((tmp.6) ())) () (() () (foobar.2.1) ()))))
          (if (if (begin
                    (set! tmp.4 -9223372036854775808)
...
(check-by-interp
 '(module ((locals (ball.8.7 ball.5.8 bat.2.6 foo.4.4 foobar.6.5 bat.3.3 bat.2.2 ball.1.1))
           (undead-out (() (() (foo.4.4) (foo.4.4) (foo.4.4) (foo.4.4) ())
                           (() (ball.8.7) (ball.8.7) ()))))
          (if (true)
              (begin
...
(check-by-interp '(module ((locals (bat.9.6 bar.5.8
                                            ...
                                            tmp.12
                                            foobar.7.7))
                           (undead-out ((tmp.12) (tmp.12)
                                                 (ball.3.5)
                                                 (ball.3.5 foobar.7.4)
                                                 (ball.3.5 foobar.7.4)
                                                 (ball.3.5 foobar.7.4 bar.0.2)
                                                 (ball.3.5 foobar.7.4 bar.0.2 bar.5.1)
                                                 (ball.3.5 foobar.7.4 bar.0.2 bar.5.1)
                                                 (ball.3.5 foobar.7.4 bar.0.2 bar.5.1)
                                                 (foobar.7.4 bar.0.2 bar.5.1)
                                                 (bar.0.2 bar.5.1)
                                                 (bar.5.1 foobar.7.7)
                                                 (foobar.7.7)
                                                 ())))
...
(check-by-interp
 '(module ((locals
           ...
           (undead-out ((((tmp.10) ()) (bat.2.3) (bat.2.3))
                        (((tmp.11 bat.2.3) (bat.2.3)) (bat.2.3 bat.4.2) (bat.2.3 bat.4.2))
                        (bat.2.3 bat.4.2)
                        (bat.2.3 bat.4.2)
                        (bat.2.3 bat.4.2 foo.1.8)
                        (bat.2.3 bat.4.2 foo.1.8)
                        (bat.4.2 foo.1.8)
                        (foo.1.8)
                        (foo.1.8)
...
(check-by-interp '(module ((locals (tmp.13 foobar.3.5
                                           ...
                                           foobar.3.4
                                           tmp.12))
                           (undead-out ((foobar.3.4) (tmp.9 foobar.3.4)
                                                     (tmp.9 foobar.3.4)
                                                     (foobar.7.3 foobar.3.4)
                                                     (tmp.10 foobar.7.3 foobar.3.4)
                                                     (tmp.10 foobar.7.3 foobar.3.4)
                                                     (foobar.7.3 foobar.3.4 foobar.5.2)
                                                     (bar.8.1 foobar.7.3 foobar.3.4 foobar.5.2)
                                                     (foobar.7.3 tmp.11 foobar.3.4 foobar.5.2)
                                                     (tmp.11 foobar.3.4 foobar.5.2)
                                                     (foobar.3.4 foobar.5.2)
                                                     (foobar.3.4 foobar.5.2)
                                                     (foobar.3.4 foobar.5.2)
                                                     (foobar.5.2)
                                                     (tmp.13)
...
(check-by-interp '(module ((locals (bat.1.1 foo.5.5 foobar.2.6 tmp.8 tmp.7 ball.9.4 ball.7.3 bat.3.2))
                           (undead-out ((((tmp.7) ()) (ball.9.4) (ball.9.4))
                                        (((tmp.8 ball.9.4) (ball.9.4)) (ball.7.3 ball.9.4)
                                                                       (ball.7.3 ball.9.4))
                                        (ball.7.3 bat.3.2 ball.9.4)
                                        (foobar.2.6 ball.7.3 bat.3.2 ball.9.4)
                                        (foobar.2.6 ball.7.3 bat.3.2 ball.9.4)
                                        (ball.7.3 bat.3.2 ball.9.4)
                                        ((ball.9.4) () ()))))
                          (begin
...
(check-by-interp
 '(module ((locals (ball.3.1 bat.1.2 tmp.10 tmp.9 foobar.5.3 bat.2.4 foo.0.5 tmp.8 ball.8.6 foo.0.7))
           (undead-out ((((tmp.8) ()) () ()) ()
                                             (bat.2.4)
                                             (((tmp.9 bat.2.4) (bat.2.4)) (bat.2.4) (bat.2.4))
                                             (tmp.10 bat.2.4)
                                             (tmp.10 bat.2.4)
                                             (bat.2.4)
                                             (bat.2.4)
...
(check-by-interp '(module ((locals (foobar.6.12 foo.3.11
                                                ...
                                                foobar.7.1
                                                tmp.13))
                           (undead-out ((() () () () (foobar.7.1) ((foobar.7.1 tmp.13) ()))
                                        (() ())
                                        ((foobar.6.12) (foobar.6.12)
                                                       (foobar.6.12)
                                                       (foobar.6.12)
                                                       (foobar.6.12)
                                                       (foobar.6.12)
...
(check-by-interp '(module ((locals (foo.6.8 foobar.3.9
                           ...
                           (undead-out ((tmp.14) (tmp.14)
                                                 (foo.1.6)
                                                 (((tmp.15 foo.1.6) (foo.1.6)) (foo.1.6 bar.8.5)
                                                                               (foo.1.6 bar.8.5))
                                                 (tmp.16 foo.1.6 bar.8.5)
                                                 (tmp.16 foo.1.6 bar.8.5)
                                                 (foo.1.6 ball.9.4 bar.8.5)
                                                 (foo.1.6 ball.9.4 bar.0.3 bar.8.5)
                                                 (foo.6.7 foo.1.6 ball.9.4 bar.0.3 bar.8.5)
                                                 (foo.1.6 ball.9.4 foobar.3.2 bar.0.3 bar.8.5)
                                                 (foo.1.6 ball.9.4 foobar.3.2 bar.0.3 bar.8.5)
                                                 (ball.9.4 foobar.3.2 bar.0.3 bar.8.5)
                                                 (foobar.3.2 bar.0.3 bar.8.5)
                                                 (bar.0.3 bar.8.5)
                                                 (bar.0.3 bar.8.5)
                                                 (bar.8.5)
                                                 (bar.8.5)
...
(check-by-interp '(module ((locals (ball.4.5 bar.0.6
                                             ...
                                             ball.8.2
                                             tmp.10))
                           (undead-out (() ((ball.4.3) (ball.4.3)
                                                       (tmp.10 ball.4.3)
                                                       (tmp.10 ball.4.3)
                                                       (ball.4.3 bar.0.1)
                                                       ((ball.4.3 bar.0.1) () ()))
                                           (((bar.0.6) (bar.0.6 ball.4.5) (bar.0.6 ball.4.5) ())
                                            (((tmp.11) ()) () ())
                                            (() () (ball.1.7) ())))))
                          (if (false)
                              (begin
...
(check-by-interp '(module ((locals (foobar.7.1 ball.6.9
                           ...
                           (undead-out ((tmp.13) (tmp.13)
                                                 ...
                                                 (ball.6.7)
                                                 ()
                                                 (((tmp.14) ()) (foobar.8.2) (foobar.8.2))
                                                 (foobar.8.2)
                                                 (foobar.8.11 foobar.8.2)
                                                 (foobar.8.11 foobar.8.2)
                                                 (foobar.8.11 foobar.8.2)
                                                 (foobar.8.2)
                                                 ())))
...
(check-by-interp '(module ((locals (ball.9.12 ball.0.13
                                              ...
                                              bat.2.5
                                              bar.8.6))
                           (undead-out ((bar.8.6) (((tmp.14 bar.8.6) (bar.8.6)) (bar.8.6) (bar.8.6))
                                                  (((tmp.15 bar.8.6) (bar.8.6)) (bar.8.6) (bar.8.6))
                                                  (bar.8.6)
                                                  (((tmp.16 bar.8.6) (bar.8.6)) (bar.5.2 bar.8.6)
                                                                                (bar.5.2 bar.8.6))
                                                  (bar.5.2 bar.8.6)
                                                  (bar.5.2 bar.8.6)
                                                  (bar.5.2 bar.8.6)
                                                  (bar.5.2 bar.8.6)
                                                  (foobar.4.7 bar.5.2 bar.8.6)
                                                  (bar.5.2 bar.8.6)
                                                  (bar.5.2 bar.8.6)
                                                  (bar.8.6)
                                                  ())))
...
(check-by-interp '(module ((locals (ball.9.14 foo.3.15
                           ...
                           (undead-out ((tmp.17) (tmp.17)
                                                 ...
                                                 (foobar.1.5 foo.0.3)
                                                 (foobar.1.5 foo.0.3)
                                                 (ball.9.12 foobar.1.5 foo.0.3)
                                                 (foobar.1.5 foo.0.3)
                                                 (ball.9.1 foobar.1.5 foo.0.3)
                                                 (foobar.1.5 foo.0.3)
                                                 (foo.0.3)
                                                 (foo.0.3)
                                                 ())))
...
(check-by-interp
 '(module ((locals (foobar.3.13 bar.7.14
           ...
           (undead-out (() ()
                           ...
                           (bar.5.5)
                           (bar.5.5)
                           (((tmp.18 bar.5.5) (bar.5.5)) (ball.0.3 bar.5.5) (ball.0.3 bar.5.5))
                           (((tmp.19 ball.0.3 bar.5.5) (ball.0.3 bar.5.5)) (ball.0.3 bar.5.5 bar.7.2)
                                                                           (ball.0.3 bar.5.5 bar.7.2))
                           (tmp.20 ball.0.3 bar.5.5 bar.7.2)
                           (tmp.20 ball.0.3 bar.5.5 bar.7.2)
                           (ball.0.3 bar.5.5 bar.7.2 bar.6.1)
                           (bar.5.5 bar.7.2 bar.6.1)
                           (bar.7.2 bar.6.1)
                           (bar.7.2 bar.6.1)
                           (bar.7.2 bar.6.1)
                           (bar.6.1)
...
(check-by-interp
 '(module ((locals (foobar.3.1 tmp.21
                               ball.2.8
                               tmp.22
                               tmp.23
                               bar.4.9
           ...
           (undead-out
            ((bat.0.3)
             ...
             (tmp.13 bat.0.3)
             (bat.0.3)
             (((tmp.14 bat.0.3) (bat.0.3)) (((tmp.15 bat.0.3) (bat.0.3)) (bar.6.6 bat.0.3)
                                                                         (bar.6.6 bat.0.3))
                                           ((tmp.16 bat.0.3) (tmp.16 bat.0.3) (bar.6.6 bat.0.3)))
             (bar.6.6 bat.0.3)
             (((tmp.17 bar.6.6 bat.0.3) (bar.6.6 bat.0.3))
              ((bar.6.6 bat.0.3))
              ((tmp.18 bar.6.6 bat.0.3) (tmp.18 bar.6.6 bat.0.3) (bar.6.6 bat.0.3)))
             (bat.0.3)
             (tmp.19 bat.0.3)
             (tmp.19 bat.0.3)
             (bat.0.3)
             ((bat.0.3) ((bat.0.3)) (bat.0.3))
             (bat.0.3)
             (tmp.20 bat.0.3)
             (tmp.20 bat.0.3)
             (bat.0.3)
             (((tmp.21 bat.0.3) (bat.0.3)) ((tmp.22 bat.0.3) (tmp.22 bat.0.3) (ball.2.8 bat.0.3))
                                           ((tmp.23 bat.0.3) (tmp.23 bat.0.3) (ball.2.8 bat.0.3)))
             (bat.0.3)
             ())))
          (begin
...
(check-by-interp
 '(module ((locals (tmp.17 bat.0.4
           ...
           (undead-out
            (((tmp.14) ())
             ((bat.8.1) (((bat.8.1) (bat.8.1) (bat.8.1)) () ((bat.8.1 tmp.16) (tmp.16) (tmp.15) ())))
             (() (() ((bat.0.4) (bat.0.4) (bat.0.4) ()) (((tmp.17) ()) () ()))
                 (() ()
                     ()
                     ()
                     (bat.5.9)
                     (bat.5.9)
                     ()
                     (((tmp.18) ()) (bar.2.6) (bar.2.6))
                     (((tmp.19 bar.2.6) (bar.2.6)) (bar.2.6) (bar.2.6))
                     (tmp.21)
                     (tmp.21)
                     (tmp.20)
                     ())))))
...
(check-by-interp
 '(module ((locals (tmp.31 tmp.32
                           ...
                           foobar.5.15))
           (undead-out
            ((((tmp.25) ()) (foo.9.8) (foo.9.8))
             (foo.9.8)
             (foo.9.8)
             (((tmp.26 foo.9.8) (foo.9.8)) (foo.9.8) (foo.9.8))
             (tmp.27 foo.9.8)
             (tmp.27 foo.9.8)
             (foo.9.8 foobar.0.5)
             (foobar.0.5 tmp.28)
             (tmp.28)
             (bat.4.4)
             (((bat.4.4) (foobar.5.13 bat.4.4)
                         (foobar.5.13 bat.4.4)
                         (foobar.5.13 bat.4.11 bat.4.4)
                         (foobar.5.13 bat.4.11 bat.4.4)
                         (bat.4.4))
              ((tmp.29 bat.4.4) (tmp.29 bat.4.4) (foo.3.3 bat.4.4))
              (((tmp.30 bat.4.4) (bat.4.4)) (foo.3.3 bat.4.4) (foo.3.3 bat.4.4)))
             ((((tmp.31 foo.3.3 bat.4.4) (foo.3.3 bat.4.4))
               ((tmp.32 foo.3.3 bat.4.4) (foo.3.3 bat.4.4))
               ((tmp.33 foo.3.3 bat.4.4) (foo.3.3 bat.4.4)))
              (foo.3.3 bat.4.4 foo.2.2)
              ((tmp.34 foo.3.3 bat.4.4) (tmp.34 foo.3.3 bat.4.4) (foo.3.3 bat.4.4 foo.2.2)))
             (foo.3.3 bat.4.4 foobar.5.1 foo.2.2)
             (((foo.3.3 bat.4.4 foobar.5.1 foo.2.2)
               (foo.3.3 bat.4.4 foobar.5.1 foo.2.2)
               (foo.3.17 foo.3.3 bat.4.4 foobar.5.1 foo.2.2)
               (foo.3.17 foo.3.3 bat.4.4 foobar.5.1 foo.2.2)
               (foo.3.17 foobar.5.15 foo.3.3 bat.4.4 foobar.5.1 foo.2.2)
               (foo.3.3 bat.4.4 foobar.5.1 foo.2.2))
              ()
              ((foo.2.2 foobar.5.1 bat.4.4 foo.3.3 foo.3.24) (foobar.5.1 bat.4.4 foo.3.3 foo.3.24)
                                                             (bat.4.4 foo.3.3 foo.3.24)
                                                             (foo.3.3 foo.3.24)
                                                             (foo.3.24)
                                                             ())))))
          (begin
...
(check-by-interp
 '(module ((locals (foobar.3.28 foo.0.29
           ...
           (undead-out
            ((foobar.5.6)
             (((tmp.33 foobar.5.6) (foobar.5.6)) (foobar.5.6) (foobar.5.6))
             (tmp.34 foobar.5.6)
             (tmp.34 foobar.5.6)
             (foobar.5.6)
             (tmp.35 foobar.5.6)
             (tmp.35 foobar.5.6)
             (foobar.5.6)
             (((tmp.36 foobar.5.6) (foobar.5.6)) (foo.6.9 foobar.5.6) (foo.6.9 foobar.5.6))
             (foo.6.9 foobar.5.6)
             (foo.6.9 foobar.5.6)
             (foo.6.14 foo.6.9 foobar.5.6)
             (foo.6.14 foo.6.9 foobar.5.6)
             (foo.6.9 foobar.5.6)
             (foo.4.5 foobar.5.6)
             (foo.6.19 foo.4.5 foobar.5.6)
             (foo.6.19 foo.4.5 foobar.5.6)
             (foo.6.19 foo.4.5 foobar.5.6)
             (ball.2.21 foo.6.19 foo.4.5 foobar.5.6)
             (ball.2.21 foo.6.19 foo.4.5 foobar.5.6)
             (foo.6.19 bat.1.18 foo.4.5 foobar.5.6)
             (((tmp.37 foo.6.19 bat.1.18 foo.4.5 foobar.5.6) (foo.6.19 bat.1.18 foo.4.5 foobar.5.6))
              (foo.6.19 bat.1.18 foo.4.5 foobar.5.6)
              (foo.6.19 bat.1.18 foo.4.5 foobar.5.6))
             (tmp.38 foo.6.19 bat.1.18 foo.4.5 foobar.5.6)
             (tmp.38 foo.6.19 bat.1.18 foo.4.5 foobar.5.6)
             (foo.6.19 bat.1.18 foo.4.5 foobar.5.6)
             (bat.1.18 tmp.39 foo.4.5 foobar.5.6)
             (tmp.39 foo.4.5 foobar.5.6)
             (ball.8.4 foo.4.5 foobar.5.6)
             (ball.8.4 foo.4.5 foo.6.3 foobar.5.6)
             (ball.8.4 foo.4.5 foo.6.3 bat.1.2 foobar.5.6)
             (tmp.40 ball.8.4 foo.4.5 foo.6.3 bat.1.2 foobar.5.6)
             (tmp.40 ball.8.4 foo.4.5 foo.6.3 bat.1.2 foobar.5.6)
             (ball.8.4 foo.4.5 foo.6.3 bat.1.2 foobar.5.6)
             (ball.8.4 tmp.41 foo.4.5 foo.6.3 bat.1.2 foobar.5.6)
             (tmp.41 foo.4.5 foo.6.3 bat.1.2 foobar.5.6)
             (foo.4.5 foo.6.3 bat.1.2 foobar.5.6)
             (foo.4.5 foo.6.3 bat.1.2 foobar.5.6)
             ((foo.4.5 foo.6.3 bat.1.2 foobar.5.6) (foo.6.3 bat.1.2 foobar.5.6)
                                                   (foo.6.3 bat.1.2 foobar.5.6))
             (bat.1.2 foobar.5.6)
             (foobar.5.6)
             (foobar.5.6)
             (foobar.5.6 foobar.5.30)
             (foobar.5.6 foobar.5.30)
             (foobar.5.30)
             ())))
          (begin
           ...
           (undead-out
            ((() (ball.0.2)
                 (() (((tmp.24) ()) () ())
                     (((tmp.25) ()) () ())
                     ()
                     (((tmp.26) ()) (ball.0.4) (ball.0.4))
                     (((tmp.27 ball.0.4) (ball.0.4)) (ball.0.4) (ball.0.4))
                     (ball.0.4 tmp.28)
                     (tmp.28)
                     (ball.0.2)))
             ((ball.0.2) (((tmp.29 ball.0.2) (ball.0.2)) (bat.4.13 ball.0.2) (bat.4.13 ball.0.2))
                         (((tmp.30 ball.0.2) (ball.0.2)) (bat.4.13 ball.0.2) (bat.4.13 ball.0.2)))
             (bat.4.13 ball.0.2)
             (bat.4.13 ball.0.2)
             (ball.1.18 bat.4.13 ball.0.2)
             (ball.1.18 bat.4.13 ball.0.2)
             (ball.1.18 bat.4.13 ball.0.2)
             (ball.1.18 bat.4.13 ball.0.2)
             (ball.8.14 bat.4.13 ball.0.2)
             (((tmp.31 ball.8.14 bat.4.13 ball.0.2) (ball.8.14 bat.4.13 ball.0.2))
              (bat.4.13 foobar.5.12 ball.0.2)
              (bat.4.13 foobar.5.12 ball.0.2))
             ((bat.4.13 foobar.5.12 ball.0.2)
              ((tmp.32 bat.4.13 foobar.5.12 ball.0.2) (tmp.32 bat.4.13 foobar.5.12 ball.0.2)
                                                      (bat.4.13 foobar.5.12 ball.0.2))
              (((tmp.33 bat.4.13 foobar.5.12 ball.0.2) (bat.4.13 foobar.5.12 ball.0.2))
               (bat.4.13 foobar.5.12 ball.0.2)
               (bat.4.13 foobar.5.12 ball.0.2)))
             (bat.4.13 foobar.5.12 ball.0.2)
             (tmp.34 bat.4.13 foobar.5.12 ball.0.2)
             (tmp.34 bat.4.13 foobar.5.12 ball.0.2)
             (bat.4.13 foobar.5.12 ball.0.2)
             (foobar.5.12 tmp.35 ball.0.2)
             (tmp.35 ball.0.2)
             (foobar.6.1 ball.0.2)
             ((ball.0.2) (ball.0.2) (ball.0.2))
             (ball.0.2)
             (foobar.7.22)
             ())))
          (begin
