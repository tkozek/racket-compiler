...
(module+ test
    ...
    (check-equal? (sequentialize-let '(module (let () 0))) '(module (begin 0)))
...
(module+ test
    ...
    (check-equal? (replace-locations '(module ((locals (x.1 y.1 w.1)) 
...
(module+ test
    ...
    (check-equal? (patch-instructions '(begin (set! fv0 0) (set! fv1 42) (set! fv0 fv1) (halt fv0)))
                '(begin (set! fv0 0) (set! fv1 42) (set! r10 fv1) (set! fv0 r10) (set! rax fv0)))
    (check-equal? (patch-instructions '(begin (set! rbx 0) (set! rcx 0) (set! r9 42) (set! rbx rcx)
