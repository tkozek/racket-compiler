...
(define-syntax-rule (check-by-interp p)
  (check-equal? (interp-asm-pred-lang-v5/assignments (check-input p))
                (interp-nested-asm-lang-v5 (check-output (replace-locations p)))))
    ...
    (define L.tmp.1.2
      ((locals (ball.8.9 ball.3.10 foobar.2.11 ball.1.12 bat.7.13))
       ...
       (conflicts ((bat.7.13 (rbp r8 rcx rdx rsi))
                   ...
                   (rdi (rbp rsi rdx))))
       (assignment ((bat.7.13 r15) (ball.3.10 r15) (ball.1.12 r15) (foobar.2.11 r15) (ball.8.9 r14))))
      (begin
        (set! bat.7.13 rdi)
        (set! ball.1.12 rsi)
        (set! foobar.2.11 rdx)
...
(check-by-interp
 '(module ((locals (foo.5.5 foo.8.4 foobar.2.3 foobar.3.2 foo.8.1))
           ...
           (conflicts
            ((foo.8.1 (foobar.3.2)) (foobar.3.2 (foo.8.1)) (foobar.2.3 ()) (foo.8.4 ()) (foo.5.5 ())))
           (assignment ((foo.8.1 r15) (foobar.3.2 r14) (foobar.2.3 r15) (foo.8.4 r15) (foo.5.5 r15))))
          (if (true)
              (begin
          ...
          (define L.proc.0.1
            ((locals (bat.3.5 tmp.6 bat.7.2 bat.4.3 foobar.2.4 bar.8.1))
             ...
             (conflicts ((bar.8.1 (bat.3.5 tmp.6 foobar.2.4 bat.7.2)) (foobar.2.4 (bar.8.1))
                                                                      ...
                                                                      (bat.3.5 (bar.8.1))))
             (assignment
              ((bar.8.1 r15) (bat.7.2 r14) (tmp.6 r13) (foobar.2.4 r14) (bat.3.5 r14) (bat.4.3 r15))))
            (begin
              (set! bar.8.1 rdi)
              (if (false)
                  (begin
 ...
 '(module ((locals ()) (undead-out ((r8 rbp) (r8 rcx rbp)
          ...
          (define L.func.0.1
            ((locals (foobar.4.1 bat.7.2 bar.1.3 foo.2.4 foo.9.5))
             ...
             (assignment ((foo.9.5 r15) (foo.2.4 r15) (bar.1.3 r15) (bat.7.2 r15) (foobar.4.1 r15))))
            (begin
              (set! foo.9.5 rdi)
              (set! foo.2.4 rsi)
              (set! bar.1.3 rdx)
