...
(define-syntax-rule (check-by-interp p)
  (check-equal? (interp-asm-pred-lang-v5/undead (check-input p))
                (interp-asm-pred-lang-v5/conflicts (check-output (conflict-analysis p)))))
 ...
 '(module ((locals (foobar.8.11 bat.1.13 foo.4.12 ball.7.9 foo.4.10))
    ...
    (if (begin
        ...
        (begin
          ...
          (halt foobar.8.11)))))
(check-by-interp
 '(module ((locals (tmp.17 tmp.16 bat.0.12 bat.2.11)) (undead-out ((tmp.16) (tmp.16)
                                                                            (bat.0.12)
                                                                            (tmp.17 bat.0.12)
                                                                            (tmp.17 bat.0.12)
                                                                            (bat.2.11 bat.0.12)
...
(check-by-interp
 '(module ((locals (foo.6.18 foo.7.19 tmp.23 foo.6.14 foo.1.15 foo.7.16 bat.4.17))
          ...
          (define L.fn.0.1
            ((locals (bat.4.1 foo.1.2 foo.3.3)) (undead-out ((rsi rdx rbp) (rdx foo.1.2 rbp)
                                                                           (bat.4.1 foo.1.2 rbp)
    ...
    (begin
      ...
      (halt 0))))
(check-by-interp '(module ((locals ()) (undead-out ((rsi rbp) (rsi rdi rbp) (rsi rdi rbp))))
                          (define L.func.0.1
                    ...
                    (define L.func.1.2
                      ((locals (bat.0.9 tmp.23
                       ...
                       (undead-out ((rsi foobar.1.8)
                                    ...
                                    ((foobar.1.8 bar.3.10) ((tmp.23 bar.3.10) (tmp.23 bar.3.10)
                                                                              (bar.3.10))
                                                           (bar.3.10))
                                    ())))
                      (begin
...
(check-by-interp '(module ((locals ()) (undead-out ()))
                          (define L.tmp.0.1
                            ((locals (bar.8.8 bar.8.1
                                              ...
                                              foobar.0.6
                                              bar.7.7))
                             (undead-out ((rsi rdx rcx r8 r9 foobar.0.6)
                            ...
                            (begin
                              ...
                              (if (if (!= bar.7.7 foobar.0.6)
                                  ...
                                  (if (begin
                                      ...
                                      (halt -9223372036854775808)))))
                    (halt 9223372036854775807)))
(check-by-interp '(module ((locals (tmp.3 foo.0.2 foo.8.1)) (undead-out (() (() () ())
                                                                            (((tmp.3) ()) () ()))))
                          (if (true)
                              (begin
                                (set! foo.0.2 1)
...
(check-by-interp
 '(module ((locals (tmp.29)) (undead-out (((tmp.29) ()) () ())))
    ...
    (if (begin
        ...
        (halt -9223372036854775808)
        (halt -1627211406))))
(check-by-interp '(module ((locals (bar.5.13 foobar.3.15 ball.0.16 bar.5.17 bat.7.18 bar.8.14 tmp.20))
                           (undead-out (() (bar.5.17)
                                           (bar.5.17)
                                           ()
                                           (bar.8.14)
    ...
    (define L.x.1.2
      ...
      (if (true)
          ...
          (begin
            ...
            (halt tmp.16))))
    (jump L.x.1.2 rbp)))
(check-by-interp '(module ((locals (foo.4.5 foobar.2.4 tmp.6)) (undead-out (((tmp.6) ()) (() () ())
                                                                                         ())))
                          (define L.x.0.1
                    ...
                    (if (begin
                        ...
                        (begin
                          ...
                          (halt -9223372036854775808))
                        (halt 0))))
(check-by-interp '(module ((locals (bat.2.2 bat.0.3 ball.5.1 tmp.4))
 ...
 '(module ((locals ()) (undead-out ()))
    ...
    (define L.fn.2.3
      ...
      (begin
        ...
        (jump L.fn.2.3 rbp rdi rsi rdx rcx r8 r9)))
    (halt 9223372036854775807)))
(check-by-interp '(module ((locals (foobar.4.4 bat.8.3 foobar.7.2 bar.5.1 tmp.5))
                           (undead-out (((tmp.5) ()) (() () ()) (() () ()))))
                          (if (not (begin
 ...
 '(module ((locals (ball.7.18 tmp.28 tmp.27 foobar.1.19 tmp.29))
    ...
    (begin
      ...
      (if (begin
          ...
          (halt 0)
          (halt 9223372036854775807)))))
(check-by-interp '(module ((locals (bat.4.2 foobar.7.1 tmp.4 tmp.5 tmp.3))
...
(check-by-interp '(module ((locals (foo.0.7 foo.0.1 ball.9.4 bat.3.5 bat.3.2 tmp.8 bar.1.3 bat.5.6))
...
(check-by-interp
 '(module ((locals (tmp.24 tmp.23)) (undead-out ((tmp.24) (tmp.24) (tmp.23) ())))
    ...
    (begin
      ...
      (set! tmp.23 tmp.24)
      (halt tmp.23))))
(check-by-interp '(module ((locals ()) (undead-out ((r9 rbp) (r9 r8 rbp)
                                                             (r9 r8 rcx rbp)
                                                             (r9 r8 rcx rdx rbp)
                                                             (r9 r8 rcx rdx rsi rbp)
                                                             (r9 r8 rcx rdx rsi rdi rbp)
                          ...
                          (define L.proc.0.1
                            ((locals (ball.6.9 foo.4.10
                             ...
                             (undead-out ((rsi rdx rcx r8 r9) (rdx rcx r8 r9)
                                                              ...
                                                              (((bar.5.1 ball.8.3 foobar.2.4 bat.3.2)
                                                                (bar.5.1 ball.8.3 foobar.2.4 bat.3.2))
                                                               ((tmp.11 ball.8.3 foobar.2.4 bat.3.2)
                                                                (tmp.11 ball.8.3 foobar.2.4 bat.3.2)
...
(check-equal? (conflict-analysis
              ...
              `(module ((locals (a.1 b.2 c.3 d.4))
                        (conflicts ((d.4 (c.3)) (c.3 (d.4 b.2 a.1)) (b.2 (a.1 c.3)) (a.1 (b.2 c.3)))))
                       (begin
                         (set! a.1 1)
                         (set! c.3 2)
                         (set! b.2 a.1)
...
(check-equal? (conflict-analysis
              ...
              `(module ((locals (x.6 x.7 y.2)) (conflicts ((y.2 (x.6)) (x.7 (x.6)) (x.6 (y.2 x.7)))))
                       (begin
                         (set! x.6 2)
                         (set! x.6 (+ x.6 3))
                         (set! x.7 x.6)
...
#;
;;works
(check-equal? (conflict-analysis `(module ((locals (y.2 x.1 B.3))
                                           (undead-out (((y.2) (x.1 y.2) (x.1 y.2)) ((x.1 y.2) (y.2))
                                                                                    ())))
                                          (begin
                                            (begin
                                              (set! y.2 1)
