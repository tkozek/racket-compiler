...
(define (check-output p)
  ...
  (define-syntax-rule (check-by-interp p)
    (check-equal? (interp-asm-pred-lang-v5/locals (check-input p))
                  (interp-asm-pred-lang-v5/undead (check-output (undead-analysis p)))))
  ;; M5 tests; Added by Trevor on March 8th 2026, multiple bindings allowed per let
  (check-by-interp '(module ((locals (foobar.8.11 bat.1.13 foo.4.12 ball.7.9 foo.4.10)))
                            (define L.fn.0.1
                      ...
                      (if (begin
                          ...
                          (begin
                            ...
                            (set! foobar.8.11 1)
                            (halt foobar.8.11)))))
  (check-by-interp '(module ((locals (tmp.17 tmp.16 bat.0.12 bat.2.11)))
                            (define L.tmp.0.1
  ...
  (check-by-interp '(module ((locals (foo.6.18 foo.7.19 tmp.23 foo.6.14 foo.1.15 foo.7.16 bat.4.17)))
                            (define L.fn.0.1
                              ...
                              (begin
                                ...
                                (if (if (!= bar.7.7 foobar.0.6)
                                    ...
                                    (if (begin
                                        ...
                                        (halt -9223372036854775808)))))
                      (halt 9223372036854775807)))
  (check-by-interp '(module ((locals (tmp.3 foo.0.2 foo.8.1)))
                            (if (true)
                                (begin
                                  (set! foo.0.2 1)
                                  (set! foo.8.1 0)
  ...
  (check-by-interp '(module ((locals (tmp.5 tmp.4)))
                            (define L.proc.0.1
  ...
  (check-by-interp '(module ((locals (tmp.6 tmp.5)))
                            (define L.tmp.0.1
  ...
  (check-by-interp '(module ((locals (ball.7.18 tmp.28 tmp.27 foobar.1.19 tmp.29)))
                            (define L.proc.0.1
  ...
  (check-by-interp '(module ((locals (tmp.18 tmp.16 ball.9.10 tmp.15 bat.5.11 tmp.17)))
                            (define L.fn.0.1
  ...
  (check-by-interp '(module ((locals (tmp.1)))
                            (if (false)
                                (halt 0)
                                (if (begin
                                      (set! tmp.1 1)
  ...
  (check-by-interp '(module ((locals ())) (halt 9223372036854775807)
                      ))
